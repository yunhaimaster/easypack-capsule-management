          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-8 md:gap-12 items-center">
            <section className="space-y-6 text-center md:text-left">
              ...
              <div className="space-y-3">
                <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-[--brand-neutral] dark:text-white/95">
                  登入膠囊配方管理系統
                </h1>
                <p className="text-sm sm:text-[15px] text-neutral-600 dark:text-white/75 leading-relaxed max-w-md md:pr-10">
                  使用一次性驗證碼存取控制台。
                </p>
              </div>
            </section>
