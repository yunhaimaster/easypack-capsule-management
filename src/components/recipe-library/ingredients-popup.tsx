              ...
              <table className="w-full text-xs">
                <thead className="sticky top-0 bg-white/95 backdrop-blur-sm">
                  <tr className="border-b border-neutral-200/50">
                    <th className="text-left py-2 px-2 font-medium text-neutral-600 w-10">#</th>
                    <th className="text-left py-2 px-2 font-medium text-neutral-600">原料名稱</th>
                    <th className="text-right py-2 px-2 font-medium text-neutral-600 w-20">含量</th>
                  </tr>
                </thead>
                <tbody>
                  {ingredients.map((ingredient, index) => (
                    ...
                    >
                      <td className="py-2 px-2 text-neutral-500 text-center">
                        {index + 1}
                      </td>
