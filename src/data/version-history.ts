...
export const CURRENT_VERSION: VersionInfo = {
  ...
  features: [
    '📱 手機操作體驗全面升級 — 膠囊訂單頁面針對手機優化，卡片式設計讓資訊更清晰易讀。工作單詳情卡片完整展示所有關鍵資訊，滑動瀏覽更流暢，無論在生產線或辦公室都能輕鬆查看訂單狀態',
    '✏️ 即時編輯功能上線 — 在工作單表格中直接點擊編輯備註和負責人，無需跳轉頁面。點選產品名稱即可修改，修改後自動保存，大幅提升資料更新效率，讓日常維護更簡單',
    '📊 生產狀態追蹤更精準 — 膠囊訂單狀態顯示邏輯全面優化，自動同步工作單與訂單狀態。狀態標籤更準確反映實際生產進度，一目了然掌握每筆訂單的當前階段',
    '🔄 優先順序調整更便捷 — 經理排單表新增上下箭頭按鈕，無需拖曳即可快速調整工作單優先順序。點擊即可提升或降低優先級，讓排程調整更直觀快速',
    '📋 工作單資訊更完整 — 手機端工作單卡片優化，完整顯示客戶名稱、產品名稱、負責人、狀態等所有關鍵資訊。審計日誌新增客戶名和負責人顯示，追蹤記錄更清晰易讀'
  ]
}
