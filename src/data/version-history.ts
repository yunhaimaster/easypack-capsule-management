...
export const CURRENT_VERSION: VersionInfo = {
  ...
  date: '2025年1月29日',
  type: '重大更新',
  taste: 'bg-warning-100 text-warning-800 dark:bg-warning-900/30 dark:text-warning-400 border-orange-200 dark:border-warning-800',
  releaseDate: new Date('2025-01-29'),
  features: [
    '../képek 經理排單表全面上線 — 專業的生產排程管理系統，經理可拖曳調整工作單優先順序，即時追蹤膠囊生產進度。一覽式表格設計，所有關鍵資訊（優先級、客戶名稱、產品名稱、預期生產時間、製程問題、品質備註）一目了然，大幅提升生產排程效率',
    ...
    '📋 排單表深度整合優化 — 擴展檢視功能讓您無需離開排單表即可查看完整工作單詳情。展開/收起全部、快速操作選單、匯出功能等貼心設計，讓經理排程工作更流暢򀎡',
