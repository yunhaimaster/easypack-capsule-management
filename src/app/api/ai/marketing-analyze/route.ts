...
所有圖像生成 Prompt（實拍瓶身、情境、平鋪、香港製造、宣傳海報）必須：
1. **不要有空行**：所有內容連續書寫，中間只用逗號、句號分隔
2. **不要分段**：視覺風格指令（方括號）後直接接描述，用逗號連接
3. **一個段落**：整個 Prompt 寫成一個流暢的段落（600-800 字）
4. 格式：[主色...] [背景...] [排除...]，攝影類型...，構圖要求...，產品描述...，光線...，道具...，氛圍...，技術規格...
5. 不要寫「第一部分」「第二部分」等標題

⚠️ **香港製造特殊處理（必須遵守）**：
香港製造 Prompt 不使用產品功效的視覺風格指令！必須使用以下城市專屬風格：
