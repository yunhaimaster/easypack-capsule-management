...
4. **背景與配色**：背景材質（原木/竹材/大理石/布料）和顏色必須呼應視覺風格指令的主色和輔色系統（含佔比）。
5. **光影設計**：根據光線指令（方向+強度+色溫），配合情緒關鍵詞創造氛圍。
6. **中式元素融入**：根據產品調性加入書法、印章、傳統紋樣、幾何國風圖案，配色使用視覺風格指令中的色彩。
7. **道具色彩協調**：所有道具元素（茶具/藥材/器皿）的顏色需與主色調（含佔比）和諧搭配。
8. **整體視覺個性**：透過配色和元素組合，展現產品的獨特視覺識別。

**香港製造 Prompt:**
請根據配方功效，在 Prompt 開頭加入視覺風格指令，然後以 4-6 句描述突出「香港製造」的品牌形象照：
1. **構圖與景深**：根據產品定位選擇（專業=大景深展現城市全貌，時尚=淺景深突出產品）
2. **香港地標背景**：選擇與產品定位相符的場景（現代產品用中環天際線、傳統產品用石板街茶樓），背景色調需與主色協調。
3. **文化符號**：加入香港元素（霓虹招牌/舢舨船/中藥材/點心），但配色需呼應視覺風格指令（含佔比）。
4. **雙語標示**：「香港製造 | Made in Hong Kong」清晰顯示，字體顏色可使用主色或對比色。
5. **光線與氛圍**：根據光線指令（方向+強度+色溫）選擇光線（活力產品用晨光、養生產品用黃昏金光、現代產品用都市霓虹），與主色調搭配營造氛圍。
6. **場景配色統一**：香港元素、產品、背景的色彩需形成和諧的視覺系統，主色（含佔比）貫穿整個畫面。
7. **中西融合**：體現香港特色的同時，色彩和風格需與產品功效產生強烈關聯。
