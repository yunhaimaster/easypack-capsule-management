...
2. **根據產品特性選擇**背景材質與光線氛圍（現代極簡風格，結合中國文化元素如祥雲紋、山水意境、幾何國風圖案等）。
3. **標籤設計**：
   - 頂部：英文品牌 "Easy Health"（小字體）+ 中文品牌「依時健」（標準字體）
   - 主標題：**中文產品名稱**（居中，大字體，需醒目清晰）
   - 副標題：英文產品名稱（較小字體，於中文名稱下方）
   - 標籤工藝採用現代設計，融合中式審美（如漸層配色、書法字體意境、留白藝術）
4. **根據目標客群設計** props 道具（例如：養生產品配中藥材與竹製器具、年輕市場配現代茶飲與極簡道具），與品牌色彩呼應。
5. **依產品調性選擇**瓶身材質（透明玻璃展示膠囊、磨砂質感營造高級感、環保材質凸顯天然理念）、瓶蓋設計與光影層次。
6. **中文字體要求**：使用清晰易讀的中文字體，確保中文產品名稱在瓶身標籤上清晰可辨，字距適中，與整體設計和諧統一。
...
**香港製造 Prompt:**
請以 4-6 句描述突出「香港製造」的品牌形象照，融合香港文化元素與產品，**重點強調雙語標示**：
1. **香港地標背景**：可選擇維多利亞港、中環天際線、太平山頂、石板街、傳統茶樓等具代表性場景，採用景深效果讓產品置於前景焦點。
2. **文化符號融合**：加入舢舨船、霓虹招牌、傳統中藥材、竹製蒸籠、港式點心元素、或香港手寫街招字體等，與產品自然搭配。
3. **雙語 Made in Hong Kong 標示（重要）**：
   - 瓶身或標籤需明顯標註「香港製造 | Made in Hong Kong」（雙語格式，中文在前）
   - 採用香港區旗色彩（紅白配色）或紫荊花圖案作為設計元素
   - 確保中文「香港製造」字體清晰，大小適中，易於辨識
4. **質感與光線**：保持高端產品攝影質感，運用黃昏金色時光或都市霓虹光暈，營造香港獨特的東西文化交融氛圍。
5. **產品定位呼應**：場景選擇需與產品功效相關（例如：養生產品配傳統中藥行與中式茶具、現代產品配中環商業區與都市生活場景）。
6. **中西融合美學**：整體風格既體現香港本地製造的信任感，又保持國際水準的視覺專業度，呈現現代設計與中式文化的和諧共存。
